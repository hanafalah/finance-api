...
return [
    ...
    'database' => [
        ...
        'database_tenant_name' => [
            'prefix' => env('FINANCE_DATABASE_PREFIX', 'finance_'),
            'suffix' => ''
        ],
    ...
    'tenancy' => [
        ...
        'cache' => [
            ...
            'tag_base' => 'finance', // This tag_base, followed by the tenant_id, will form a tag that will be applied on each cache call.
        ],
