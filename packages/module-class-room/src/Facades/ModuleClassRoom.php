...
namespace Hanafalah\ModuleClassRoom\Facades;
 ...
 */
class ModuleClassRoom extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleClassRoom\Contracts\ModuleClassRoom::class;
  }
}
