...
use Hanafalah\SatuSehat\Contracts\Data\Fhir\Encounter\ParamEncounterSatuSehatData as DataParamEncounterSatuSehatData;
use Spatie\LaravelData\Attributes\MapInputName;
use Spatie\LaravelData\Attributes\MapName;
use Spatie\LaravelData\Attributes\Validation\DateFormat;
use Illuminate\Support\Str;

class ParamEncounterSatuSehatData extends ParamSatuSehatData implements DataParamEncounterSatuSehatData
{
    #[MapInputName('name')]
    #[MapName('name')]
