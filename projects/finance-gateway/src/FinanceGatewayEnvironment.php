...
abstract class FinanceGatewayEnvironment extends BaseServiceProvider{
    protected $__config_finance_gateway = [];
    ...
    public function __construct(Container $app) {
        ...
        $this->__config_finance_gateway = $this->__config['finance-gateway'];
    }
    ...
    public function getRouteBasePathResult(): string{
        return '/Routes';
    }
